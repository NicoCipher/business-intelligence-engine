...
| --- | --- |
| Citation | title/content part; exact case; non-empty; overlap ordinal; support containment; direct-SQL rejection of post-insert `signals.title`/`content` updates. |
